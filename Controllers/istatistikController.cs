...
namespace MvcOnlineTicariOtomasyon.Controllers
{
    public class istatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.d12 = deger12;
            var deger13 = c.Uruns.Where(u=>u.Urunid == (c.SatisHarekets.GroupBy(x => x.Urunid).OrderByDescending(z => z.Count()).Select(y => y.Key).FirstOrDefault())).Select(l=>l.Urunad).FirstOrDefault();
            ViewBag.d13 = deger13;
        ...
        {
            var sorgu2 = from x in c.Personels group x by x.Departmanid into g select new SinifGrup2
            {
                Departman = g.Key,
                Sayi = g.Count()
            };
